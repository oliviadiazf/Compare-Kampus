        ...
        <div class="container pt-4 bg-white">
            <div class="row">
                <div class="col-md-8 col-xl-6">
                    <h1>Tambah Data Kampus</h1>
                    <hr>

                    <form action="{{ route('kampuses.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="nama_kampus">Nama Kampus</label>
                            <input type="text"
                            class="form-control @error('nama_kampus') is-invalid @enderror"
                            id="nama_kampus" name="nama_kampus" value="{{ old('nama_kampus') }}">
                            @error('nama_kampus')
                        ...
                        <div class="form-group">
                            ...
                            id="akreditasi" name="akreditasi" value="{{ old('akreditasi') }}">
                            @error('akreditasi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            id="peringkat_asia" name="peringkat_asia" value="{{ old('peringkat_asia') }}">
                        ...
                        <div class="form-group">
                            ...
                            id="peringkat_lokal" name="peringkat_lokal" value="{{ old('peringkat_lokal') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                class="custom-file-input @error('gambar_profil') is-invalid @enderror" value="{{ old('gambar_profil') }}">
